...
import { Edit, Trash2, Plus, Package, ShoppingCart, DollarSign, Users, MoreVertical } from "lucide-react"
...
export default function Admin() {
  ...
  const totalRevenue = orders?.reduce((sum: number, order: any) => sum + Number.parseFloat(order.total), 0) || 0
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-lg sm:text-2xl font-bold text-primary">{totalProducts}</p>
                  </div>
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-lg sm:text-2xl font-bold text-accent">₦{totalRevenue.toFixed(2)}</p>
                  </div>
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-lg sm:text-2xl font-bold text-purple-600">-</p>
                  </div>
                            ...
                            <TableCell>
                              <div className="flex items-center space-x-3">
                                <img
                                  src={
                                    product.imageUrl ||
                                    "https://images.unsplash.com/photo-1549298916-b41d501d3772?ixlib=rb-4.0.3&auto=format&fit=crop&w=50&h=50"
                                  }
                                  alt={product.name}
                      ...
                      <Card key={product.id} className="p-4">
                        <div className="flex items-start space-x-4">
                          <img
                            src={
                              product.imageUrl ||
                              "https://images.unsplash.com/photo-1549298916-b41d501d3772?ixlib=rb-4.0.3&auto=format&fit=crop&w=60&h=60"
                            }
                            alt={product.name}
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex justify-between items-start">
                              <div>
                                ...
                                <p className="text-xs text-gray-600 capitalize mt-1">{product.category}</p>
                              </div>
                              <DropdownMenu>
                        ...
                        <div className="space-y-2">
                          {order.orderItems.map((item: any) => (
                            <div key={item.id} className="flex items-center justify-between text-sm">
                              ...
                              <span className="whitespace-nowrap">₦{Number(item.price).toLocaleString("en-NG")}</span>
                            </div>
                          ))}
