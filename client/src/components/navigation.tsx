        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {user ? (
              ...
              <>
                <Link href="/signin" className={`text-gray-700 hover:text-gray-900 font-medium transition-colors pb-1${location === "/signin" ? "text-gray-900 border-b-2 border-gray-900" : ""}`}>
                  Sign In
                </Link>
                <Link href="/signup" className={`text-gray-700 hover:text-gray-900 font-medium transition-colors pb-1${location === "/signup" ? "text-gray-900 border-b-2 border-gray-900" : ""}`}>
                  Sign Up
                </Link>
              </>
            )}
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
              {user ? (
                <>
                  ...
                  <button onClick={signOut} className="block px-3 py-2 text-gray-700 hover:text-gray-900 font-medium w-full text-left">
                    Sign Out
                  </button>
                </>
              ) : (
                <>
                  <Link href="/signin" className="block px-3 py-2 text-gray-700 hover:text-gray-900 font-medium">
                    Sign In
                  </Link>
                  <Link href="/signup" className="block px-3 py-2 text-gray-700 hover:text-gray-900 font-medium">
                    Sign Up
                  </Link>
                </>
              )}
